...
namespace Library.App_Code.MultipleFramworks
{
    public class SQLFramework
    {
        ...
        private static SqlConnection Tcon;
        private static SqlCommand Tcmd;
        ...
        {
            string constr = ConfigurationManager.ConnectionStrings["SqlConn"].ConnectionString.ToString();
            return constr;
        }
        ...
        {
            SqlConnection Lcon = new SqlConnection(GetConnectionString(System.Web.HttpContext.Current.Session["LibWiseDBConn"].ToString()).ToString());
            SqlCommand Lcmd = new SqlCommand();
            Lcon.Open();
            Lcmd.CommandType = CommandType.StoredProcedure;
            Lcmd.CommandText = "LoginStatus";
            Lcmd.Connection = Lcon;
            Lcmd.Parameters.Add("@userid", SqlDbType.VarChar).Value = userid.Trim().ToString();
            Lcmd.Parameters.Add("@Lstatus", SqlDbType.VarChar).Value = Lstatus;
        ...
        {
            Tcon = new SqlConnection(ConnectionString);
            Tcon.Open();
        ...
        public string ExecuteScalarTrans(string ProcedureName, ParameterCollection Parameters)
        {
            ...
            string Value = Tcmd.ExecuteNonQuery().ToString();// Tcmd.ExecuteScalar();
            return Value;
        }
        ...
        public bool ExecuteProcedureTrans(string ProcedureName, ParameterCollection Parameters, string ConnectionString)
        {
            ...
            try
            {
                ...
                SqlCommandBuilder.DeriveParameters(Tcmd);
