    ...
    <script src="LibUtils.js"></script>
		<script  type="text/javascript">
            ...
            function locationGrid() {
                //
                let cps = $("table[id$='grdcopy'] ").find('[id*=txtCpLoc]');
                //alert(cps.length);

                cps.each(function () {
                    $(this).on('keyup',function () {
                        let nombre = $(this).val();
                        let idtx = $(this).attr('id');
                        $('#' + idtx).autocomplete({
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    Note: "Apply to copies" not to use<br />
    make bookaccessionmaster proc to accept all copies of 1 ctrl_no and validate in database
    then save (insert/update)
...
<%--                            This field is not emptied - stores whether booknumber to be stored in accessionmaster and so on--%>
        ...
        <asp:label id="lblTitleCatalogue" runat="server"  Text="<%$ Resources:ValidationResources, Title_Catdet %>"></asp:label></div>
                ...
                <asp:label id="msglabel" runat="server"  CssClass="err" Height="8px"></asp:label>
                                  ...
                                  <tr><td colspan="4">
                                    ...
                                    <tr>
                                        <td>
                                        <asp:label id="Label4" runat="server"  CssClass="span" Text="<%$ Resources:ValidationResources, LBCatlg %>"></asp:label></td>
                                        <td>
 ...
 <%--pushpendra singh--%>
                                        ...
                                        <td>
                                           <asp:Label ID="Labelb" runat="server" CssClass="span"  Text="<%$ Resources:ValidationResources, LBaDa %>"></asp:Label>
                                            <asp:Label ID="Label7" runat="server" CssClass="span"  Text="Control No"></asp:Label>
                                        </td>

                                        <td >
                                             <asp:TextBox ID="txtControlNo" runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" />
                            ...
                            onfocus="this.className='focus'" Width="398px"></asp:DropDownList>--%>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="4" >
                                                    <table style="width: 100%" class="no-more-tables GenTable1">
                                                        ...
                                                        <tr>
                                                            <td >
                                                                <img id="image1" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="  height="78" width="99" runat="server" border="1" />
                                                                
                                                                <input type="file" id="imgupload"   />
                                                                <asp:HiddenField ID="hdimgdata" runat="server" />
                                            ...
                                            <tr>
                                                <td colspan="5" style="text-align:center">
                                                                ...
                                                                <input id="cmdsave1" style="display:none" onclick="PrepareMARC_21();" class="btnstyle" type="submit" value="Submit"
                                                                    runat="server"><input id="cmdReset1" class="btnstyle" type="submit" style="display:none;" value="Reset"
                                                                        runat="server">

                                                    <asp:Button ID="cmdReset1_1" style="display:none" runat="server" CssClass="btn btn-primary" Text="Reset" OnClick="cmdReset1_1_Click" />
                                        ...
                                        <td style="text-align:center" colspan="2" style="width: 72px" >
                                            <input id="cmdReturnMainT" runat="server" style="width: 149px;
                                                height: 24px" type="button" value="<%$resources: ValidationResources,bReturn %>" accesskey="H" /></td>
													...
													<asp:datagrid id="grdcopy" CssClass="table  table-condensed "   runat="server" AllowPaging="false" 
														AutoGenerateColumns="False" CellPadding="0"  BackColor="White">
														<Columns>
                                                            <asp:TemplateColumn HeaderText="Check to Save">
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkcheck" runat="server" />
                                                            ...
                                                            <asp:TemplateColumn HeaderText="<%$ Resources:ValidationResources,GrPubYr %>">
                                                                <ItemTemplate>                                                                  
                                                                         <INPUT type="text" style="width:70px;" runat="server" id="txtPubYear" maxlength="4" value='<%# DataBinder.Eval(Container, "DataItem.pubYear") %>' onkeypress="IntegerNumber(this);" size="5" >
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                            <asp:TemplateColumn HeaderText="<%$ Resources:ValidationResources,LnbspOrgCurrency %>">
                                                                <ItemTemplate>
                                                                    <asp:DropDownList ID="cmbOriCurrency" runat="server" Height="30" Width="50"   OnSelectedIndexChanged="cmbOriCurrency_SelectedIndexChanged" AutoPostBack="true">
                                                                    </asp:DropDownList>
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                            ...
                                                            <asp:TemplateColumn HeaderText="<%$ Resources:ValidationResources,LCatSource %>">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtCmbVendor" Width="120" runat="server" Text='<%# Eval("cat_source") %>' ></asp:TextBox>
<%--                                                                     <Custom:AutoSuggestBox ID="txtCmbVendor" runat="server" AutoPostBack="false" BorderWidth="1px"
                                            ...
                                            <asp:TextBox ID="hdnCpLocId" runat="server" Text='<%# Eval("loc_id") %>' style=" display:none"></asp:TextBox>
                                                            ...
                                                            <asp:TemplateColumn HeaderText="<%$ Resources:ValidationResources,RBCourse %>">
                                                                <ItemTemplate>
                                                                    <asp:DropDownList ID="cmbCourse" runat="server" Height="30" Width="60"  onblur="this.className='blur'" onfocus="this.className='focus'" OnSelectedIndexChanged="cmbCourse_SelectedIndexChanged" AutoPostBack="true">
                                                                    </asp:DropDownList>
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                            ...
                                                            <asp:TemplateColumn HeaderText="<%$ Resources:ValidationResources,rptDepartment %>">
                                                                <ItemTemplate>
                                                                    <asp:DropDownList ID="CmbGrdDept" runat="server" Height="30" Width="120"  onblur="this.className='blur'" onfocus="this.className='focus'" OnSelectedIndexChanged="CmbGrdDept_SelectedIndexChanged" AutoPostBack="true">
                                                                    </asp:DropDownList>
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                            <asp:TemplateColumn HeaderText="<%$ Resources:ValidationResources,ItemCats %>">
                                                                <ItemTemplate>
                                                                    <asp:DropDownList ID="CmbItemType" runat="server" Width="100" Height="30"  onblur="this.className='blur'" onfocus="this.className='focus'" OnSelectedIndexChanged="CmbItemType_SelectedIndexChanged" AutoPostBack="true">
                                                                    </asp:DropDownList>
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                            <asp:TemplateColumn HeaderText="Item Category">
                                                                <ItemTemplate>
                                                                    <asp:DropDownList ID="CatItemType" runat="server" Height="30" Width="100"  onblur="this.className='blur'" onfocus="this.className='focus'" OnSelectedIndexChanged="CatItemType_SelectedIndexChanged" AutoPostBack="true">
                                                                    </asp:DropDownList>
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
...
<INPUT id="xCoordHolder" type="hidden" size="1" value="0" name="xCoordHolder" runat="server"><INPUT id="Hidden6" type="hidden" size="1" name="Hidden2" runat="server"><INPUT id="Hidden7" type="hidden" size="1" name="Hidden1" runat="server"><INPUT id="Hidden8" type="hidden" size="1" name="Hidden1" runat="server"><INPUT id="yCoordHolder" type="hidden" size="1" value="0" name="yCoordHolder" runat="server"><INPUT id="hdForMesage" type="hidden" size="1" name="hdForMesage" runat="server"><input id="hrDate1" runat="server" value="<%$ Resources:ValidationResources, GridDateF %>" style="<%$ Resources:ValidationResources, TextBox2 %>; width: 8px;" type="hidden" />
           ...
           <asp:Button ID="btnBackScateg" runat="server" CssClass="btn btn-primary" Text="Back" OnClick="btnBackScateg_Click" />
      </ContentTemplate>
        <Triggers >
      ...
      <div style="display:none">				<input id="btnPub" runat="server" onclick="openNewForm('btnFillPub', 'PublisherMaster', 'HNewForm', 'HWhichFill', 'HCondition');" accesskey="P" style="width: 1px; height: 1px;" type="button"
        ...
        <script type="text/javascript">
            ...
            function uploadImage() {
                const inputElement =  document.getElementById('imgupload');// .querySelector('input[type="file"]');
                ...
                // Handle the results of the file read
                reader.addEventListener('load', (event) => {
                    // Get a reference to the hidden input element where the file data should be stored
                    const hiddenInputElement = document.getElementById('MainContent_hdimgdata');//.querySelector('input[type="hidden"]');
                    const imagesh = document.getElementById('MainContent_image1');
                    // Set the value of the hidden input element to the file data URL
                    imagesh.src = event.target.result;
                    hiddenInputElement.value = event.target.result;
                });
            }
